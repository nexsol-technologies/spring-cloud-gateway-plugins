 ...
 * else is invisible to it. The config carries no argument, yet the factory still
 * instantiates it reflectively for every route that names the filter.
 */
class GatewayAuditRuntimeHints implements RuntimeHintsRegistrar {

	@Override
	public void registerHints(RuntimeHints hints, ClassLoader classLoader) {
		hints.reflection()
			.registerType(AuditGatewayFilterFactory.Config.class, MemberCategory.ACCESS_DECLARED_FIELDS,
