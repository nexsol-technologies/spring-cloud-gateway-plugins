 ...
 * <p>
 * The rewritten document itself needs nothing: it is read into a map and written back,
 * never bound to the OpenAPI model classes.
 */
class OpenapiHubRuntimeHints implements RuntimeHintsRegistrar {

	@Override
	public void registerHints(RuntimeHints hints, ClassLoader classLoader) {
		hints.reflection()
			.registerType(OpenapiModifyResponseBodyGatewayFilterFactory.Config.class,
